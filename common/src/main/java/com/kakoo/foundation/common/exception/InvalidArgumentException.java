...
/**
 * Unchecked exception thrown to indicate a method has been passed an illegal or inappropriate argument.
 * <hr>
...
public class InvalidArgumentException extends AbstractUncheckedException
{
     ...
     * enumeration implementing the {@link com.kakoo.foundation.common.resource.bundle.IBundle} interface).
     */
